...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="fk-theme"
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/fkoperwas/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/fkoperwas/.mailcheckrc"
# }
